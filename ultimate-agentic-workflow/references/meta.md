...
| GSD (original gsd-build/get-shit-done archived after a 2026 token rug-pull; successor open-gsd/gsd-core, npm `@opengsd/gsd-core`, unproven) | Spec-driven system with research/plan/execute/verify agent roles | The named four-role split — mirrored by our researcher/implementer/test-runner/skeptic-verifier agents; GSD itself overlaps UAW, so know the lineage and evaluate before adopting rather than default-installing |
